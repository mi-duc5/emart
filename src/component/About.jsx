            ...
            <div className="container py-5 my-5">
                <div className="row">
                    ...
                    <div className="col-md-6 d-flex justify-content-center">
                        <img src="https://raw.githubusercontent.com/Muhammad-Feroz/React-Ecommerce-App/master/public/assets/images/about.png" alt="About Us" height="400px" width="400px" />
                    </div>
                </div>
            </div>
        </div>
