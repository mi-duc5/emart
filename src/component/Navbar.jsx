      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-white py-3 shadow-sm">
        <div className="container">
          <Link className="navbar-brand fw-bold fs-4" to="/">
            <img src="https://images.squarespace-cdn.com/content/v1/5cc2742bd86cc9589d3323fa/1576611099678-10U7XA8JANY1HUD08C2E/fina_TMDlogo.gif?format=1500w" alt="" style={{width: 28, height: 28}}></img>
          </Link>
